 ...
 * TextureCacheServlet
 *
 * Whenever an Agent lands on a Region or changes its outfit. all the texture
 * Layers will be baked to a single Texture and this Texture is stored in the
 * cache of the Region Server
 *
 * Because of the separated Caches of the RegionServer (Flotsam) and the
 * Surabaya Infinispan cache the baked Textures have to be copied from the
 * RegionServer to Surabaya in order to make them accessible using the
 * GetTexture CAPS
 *
 * Author: Akira Sonoda
 */
