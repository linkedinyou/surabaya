...
@Stateless
@LocalBean
public class InventoryService_3 {
    private static final Logger log = LoggerFactory.getLogger(InventoryService_3.class);
    ...
    public InventoryCollection_2 getFolderContent( UUID userID, UUID folderID, String inventoryServerURL ) {
        log.debug("getFolderContent(userID:{}, folderID:{} )", userID, folderID);
        InventoryCollection_2 invCollection = new InventoryCollection_2();
